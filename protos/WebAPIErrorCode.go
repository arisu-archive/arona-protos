...
const (
	...
	WebAPIErrorCode_AccountCheckAdultAgreeIsNull                   WebAPIErrorCode = 1018
	WebAPIErrorCode_YostarCheckFail                                WebAPIErrorCode = 1019
	WebAPIErrorCode_EnterTicketInvalid                             WebAPIErrorCode = 1020
	WebAPIErrorCode_EnterTicketTimeOut                             WebAPIErrorCode = 1021
	WebAPIErrorCode_EnterTicketUsed                                WebAPIErrorCode = 1022
	WebAPIErrorCode_AccountCommentLengthOverLimit                  WebAPIErrorCode = 1023
	WebAPIErrorCode_AccountUpdateBirthdayFailed                    WebAPIErrorCode = 1024
	WebAPIErrorCode_AccountLoginError                              WebAPIErrorCode = 1025
	WebAPIErrorCode_AccountCurrencySyncError                       WebAPIErrorCode = 1026
	WebAPIErrorCode_NexonCheckFail                                 WebAPIErrorCode = 1027
	WebAPIErrorCode_NexonDetachFail                                WebAPIErrorCode = 1028
	WebAPIErrorCode_NexonHttpResponseErrorStatusCode               WebAPIErrorCode = 1029
	WebAPIErrorCode_NexonNetworkException                          WebAPIErrorCode = 1030
	WebAPIErrorCode_NexonException                                 WebAPIErrorCode = 1031
	WebAPIErrorCode_NexonNgsmValidateFail                          WebAPIErrorCode = 1032
	WebAPIErrorCode_InvalidClientCookie                            WebAPIErrorCode = 1033
	WebAPIErrorCode_InappositeNicknameRestricted                   WebAPIErrorCode = 1034
	WebAPIErrorCode_InappositeCommentRestricted                    WebAPIErrorCode = 1035
	WebAPIErrorCode_InappositeCallnameRestricted                   WebAPIErrorCode = 1036
	WebAPIErrorCode_AccountPCTeenBlock                             WebAPIErrorCode = 1037
	WebAPIErrorCode_AccountContentBan                              WebAPIErrorCode = 1038
	WebAPIErrorCode_InvalidAccountOptionsRequest                   WebAPIErrorCode = 1039
	...
	WebAPIErrorCode_ShopSalePeriodTimeOver                         WebAPIErrorCode = 10016
	WebAPIErrorCode_BeforehandGachaMetadataNotFound                WebAPIErrorCode = 10017
	WebAPIErrorCode_BeforehandGachaCandidateNotFound               WebAPIErrorCode = 10018
	WebAPIErrorCode_BeforehandGachaInvalidLastIndex                WebAPIErrorCode = 10019
	WebAPIErrorCode_BeforehandGachaInvalidSaveIndex                WebAPIErrorCode = 10020
	WebAPIErrorCode_BeforehandGachaInvalidPickIndex                WebAPIErrorCode = 10021
	WebAPIErrorCode_BeforehandGachaDuplicatedResults               WebAPIErrorCode = 10022
	WebAPIErrorCode_ShopCannotRefreshManually                      WebAPIErrorCode = 10023
	WebAPIErrorCode_PickupSelectionDataNotFound                    WebAPIErrorCode = 10024
	WebAPIErrorCode_PickupSelectionDataInvalid                     WebAPIErrorCode = 10025
